...
const doubleRoom = () => {
    const images = [
        "https://augustine.qodeinteractive.com/wp-content/uploads/2020/11/room-gallery-14.jpg",
        "https://augustine.qodeinteractive.com/wp-content/uploads/2020/11/Room-img09.jpg",
    ];
                        ...
                        <div className="space-y-4 sm:space-y-6">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                              ...
                              border-b border-gray-200 sm:border-none">
                                    ...
                                    <span className="text-emerald-700 font-bold text-sm sm:text-lg tracking-wide">2-6 PERSONS</span>
                                </div>
