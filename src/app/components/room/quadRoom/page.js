...
const tripleRoom = () => {
    const images = [
        "https://api.staybluo.com/property_assets/property_images/149/1735638563-8.jpeg",
        "https://api.staybluo.com/property_assets/property_images/149/1735638427-12.jpeg",
    ];
                        ...
                        <div className="space-y-4 sm:space-y-6">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                              ...
                              border-b border-gray-200 sm:border-none">
                                    ...
                                    <span className="text-emerald-700 font-bold text-sm sm:text-lg tracking-wide">2 </span>
                                </div>
