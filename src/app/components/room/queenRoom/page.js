...
const queenRoom = () => {
    ...
    return (
        <div className="min-h-screen flex justify-center items-center bg-gradient-to-br from-gray-50 to-gray-100 py-4 sm:py-8 px-4">
                        ...
                        <div className="space-y-4 sm:space-y-6">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                              ...
                              border-b border-gray-200 sm:border-none">
                                    ...
                                    <span className="text-emerald-700 font-bold text-sm sm:text-lg">60M²</span>
                                </div>

                                <div className="flex sm:flex-col items-center sm:items-start justify-between sm:justify-start 
                              py-3 sm:py-0 px-4 sm:px-0 bg-gray-50 sm:bg-transparent rounded-lg sm:rounded-none">
                                    <span className="text-gray-600 font-medium text-sm sm:text-base">Price</span>
                                    <span className="text-emerald-700 font-bold text-lg sm:text-2xl">$94</span>
                                </div>
                            </div>

                            {/* Description */}
                            <p className="text-gray-600 leading-relaxed text-sm sm:text-base md:text-lg text-center sm:text-left">
                                Indulge in cozy elegance in our well-appointed queen room, perfect for solo travelers or couples seeking a restful retreat.
                                Featuring a plush queen-size bed, tasteful décor, and modern comforts, it offers a serene space to unwind and recharge in style.
                            </p>
