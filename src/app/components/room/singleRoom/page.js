...
const SingleRoom = () => {
  const images = [
    'https://augustine.qodeinteractive.com/wp-content/uploads/2020/11/Room-img08.jpg',
    'https://augustine.qodeinteractive.com/wp-content/uploads/2020/11/room-gallery-13.jpg'
  ];
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                <div className="flex sm:flex-col items-center sm:items-start justify-between sm:justify-start 
                  ...
                  <span className="text-emerald-700 font-bold text-sm sm:text-lg tracking-wide">1-4 PERSONS</span>
                </div>
                ...
                <div className="flex sm:flex-col items-center sm:items-start justify-between sm:justify-start 
                  ...
                  <span className="text-emerald-700 font-bold text-sm sm:text-lg">68M²</span>
                </div>

                <div className="flex sm:flex-col items-center sm:items-start justify-between sm:justify-start 
                              py-3 sm:py-0 px-4 sm:px-0 bg-gray-50 sm:bg-transparent rounded-lg sm:rounded-none">
                  <span className="text-gray-600 font-medium text-sm sm:text-base">Price</span>
                  <span className="text-emerald-700 font-bold text-lg sm:text-2xl">$119</span>
                </div>
              </div>

              {/* Description */}
              <p className="text-gray-600 leading-relaxed text-sm sm:text-base md:text-lg text-center sm:text-left">
                Experience luxury and comfort in our beautifully designed single room.
                Perfect for business travelers or couples seeking a peaceful retreat,
                featuring modern amenities and elegant furnishings that create an
                unforgettable stay.
              </p>
